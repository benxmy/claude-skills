...
| Microsoft Graph CLI (`msgraph`) | Search email for recording URLs and passwords. Any CLI or MCP tool that can search Outlook/M365 email works. | Only if using email search (not direct URL) |
